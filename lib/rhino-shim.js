...
// This seems to match Node.js' global better. Wonder what it breaks...
global = (function() {
    return this;
})(null);
 ...
 */
console = (function() {
    // TODO: this needs to accept sprintf-style parameters, rather than just dumping everything
    function logger(/*...*/) {
    ...
    return {
        error: logger,  // TODO: refactor so this can go to java.lang.System.err
        log: logger
    };
})();
